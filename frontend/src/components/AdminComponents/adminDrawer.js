    ...
    render() {
        ...
        return (
            <Navigation>
                ...
                <h1 className='titleMenu' onClick={() => { this.showRecords() }}>RECORDS <FontAwesomeIcon icon={recordIcon} /></h1>
                <span className={recordClass}>
                    <Link className='link-menu' to="/AssessmentList">Assessment List</Link>
                    <Link className='link-menu' to="/PatientList">Patient List</Link>
                    <Link className='link-menu' to="/ReferredList">Referrals</Link>
                ...
                <br />
                <h1 className='titleMenu' onClick={() => { this.showWorkers() }}>REPORTS <FontAwesomeIcon icon={workerIcon} /></h1>
                <span className={workersClass}>
                    <Link className='link-menu' to="/CommunityReport">Community Report</Link>
                    <Link className='link-menu' to="/request-VHT-report">VHT Report</Link>
                </span>
